...
export const SalesChartSection = ({ sales, userName }: SalesChartSectionProps) => {
  const { data: totalPurchases = [], isLoading } = useQuery({
  ...
  return (
    <div className="stat-card">
      <h3 className="text-gray-400 mb-4">Försäljning över tid</h3>
      <SalesChart transactions={totalPurchases} groupByWeek={true} />
    </div>
  );
};